...
class BlueEnemy extends Enemy {
  ...
  protected engage() {
    ...
    if (this.playerIsNearby()) {
      ...
      this.shootCooldown = random(2_500, 3_500); //labba med detta
    }
  }
  private playerIsNearby() {
    ...
    return (
      distX < GamePanel.worldWidth * shootLimit &&
      distY < GamePanel.worldHeight * shootLimit
    );
  }
